...
export function JobQueue() {
  ...
  const fetchLeads = async () => {
    try {
      // HARDCODED FOR TESTING: Show only the Synectic Systems Resumator job
      const hardcodedLead = {
        id: 999,
        job_title: "Software Developer, Journeyman (SED)",
        company: "Synectic Solutions",
        pay_range: "$80,000 - $120,000",
        description: "We are seeking a skilled Software Developer to join our team. The ideal candidate will have experience in full-stack development and work on mission-critical applications.",
        location: "Remote",
        employment_type: "Full-time",
        experience_level: "Mid-level",
        source_url: "http://synecsolu.applytojob.com/apply/Iogwovl3gB/Software-Developer-Journeyman-SED",
        is_active: true,
        created_at: new Date().toISOString(),
        updated_at: new Date().toISOString(),
        auto_fill_data: {
          has_structure: false, // Will use fallback selectors for Resumator
          platform_name: "Resumator",
      ...
      setLeads([hardcodedLead]);
      setIsRelevantJobs(false);
    } catch (error) {
